...
\begin{tabularx}{\textwidth}{>{\hsize=.25\textwidth}XX}
	...
	\makecell[tl]{
	\details{Designed a microactuator to automate the hair-grabbing process.    }                                                                                                                                                  \\
	\details{Improved the quality and speed of hair braiding by implementing the fully automated process.}                                                                                                                         \\
	\details{Mechanically designed the actuator for R\&D process and prepared the manufacturing drafts for mass production.}                                                                                                       \\[0.3cm]
	}                                                                                                                                                                                                                              \\
	\makecell[tr]{
	...
	\makecell[tl]{
	\details{Led a team of ten mechanical and software engineers in developing a real-time software system from scratch, encompassing program parsing, motion generation, interrupt handling, and IO control for the robots.}      \\
