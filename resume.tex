...
\begin{tabularx}{\textwidth}{>{\hsize=.25\textwidth}XX}
	...
	\makecell[tl]{
	\details{Led a multidisciplinary team of mechanical and software engineers to design, prototype, and test a custom autonomous platform equipped with an embedded Delta robot for targeted weed eradication.} \\
	\details{Developed a real-time control application using embedded systems to operate both the Delta robot and the autonomous platform.} \\
	\details{Integrated RGB-D cameras, LiDAR, and IMU sensors to enable local and global path planning as well as localization.} \\
	\details{Accelerated control algorithms using CUDA programming to enhance system performance.} \\
	\details{Conducted extensive testing and validation of the control algorithms on actual hardware, including NVIDIA Jetson series modules and an industrial PC.} \\
	\details{Successfully delivered a custom autonomous platform, covering software development, calibration, testing, mechanical analysis, and field validation.} \\
	\details{Designed and implemented a specialized application machine that improved overall system efficiency through seamless integration of hardware and software capabilities.} \\[0.3cm]
	} \\
	\makecell[tr]{
	...
	\details{Led mechanical design efforts for R\&D and produced detailed manufacturing drafts to prepare the actuator for mass production.} \\
	} \\
	\makecell[tr]{
		\jobtitle{Research Assistant}
		\company{AVEC Lab}
		\companydate{2021-2025}
